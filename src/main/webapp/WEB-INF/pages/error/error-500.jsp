...
<body class="d-flex align-items-center justify-content-center" style="min-height:100vh;">
  <div class="text-center px-3" style="max-width:520px;">
    <p class="display-1 fw-bold mb-2" style="letter-spacing:-.04em;">500</p>
    <h1 class="h4 fw-bold mb-3">サーバーエラーが発生しました</h1>
    <p class="text-muted mb-4">しばらくしてからもう一度お試しください。</p>
