    ...
    <div class="row g-4">
      ...
      <section class="col-lg-9">
        ...
        <div class="filter-bar">
          <a href="#my-approvals" class="btn btn-teal btn-sm"><i class="bi bi-inbox"></i> 自分の決裁箱 <span class="badge bg-white text-teal ms-1">3</span></a>
          ...
          <a href="${pageContext.request.contextPath}/pages/approval-write.do" class="btn btn-teal btn-sm ms-auto"><i class="bi bi-file-earmark-plus"></i> 新規決裁申請</a>
        </div>

        <div class="panel" id="my-approvals">
          <div class="panel-header">
            <h5><i class="bi bi-inbox"></i> 自分の決裁箱</h5><span class="small text-muted">あなたの承認が必要な文書のみ</span>
          </div>
            ...
            <table class="table list-table mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="${pageContext.request.contextPath}/pages/approval-view.do" class="title-link">年次休暇申請書</a><div class="small text-muted">一次承認：佐藤 花子</div></td>
                ...
                <tr>
                  ...
                  <td><a href="${pageContext.request.contextPath}/pages/approval-view.do" class="title-link">出張報告書（大阪出張）</a></td>
                ...
                <tr>
                  ...
                  <td><a href="${pageContext.request.contextPath}/pages/approval-view.do" class="title-link">備品購入申請書（モニター2台）</a></td>
                ...
                <tr>
                  ...
                  <td><a href="${pageContext.request.contextPath}/pages/approval-view.do" class="title-link">在宅勤務申請書</a></td>
                ...
                <tr>
                  ...
                  <td><a href="${pageContext.request.contextPath}/pages/approval-view.do" class="title-link">経費精算書（8月分交通費）</a></td>
        ...
        <div class="panel mt-4">
          <div class="panel-header"><h5><i class="bi bi-collection"></i> 起案済み・完了文書</h5><span class="small text-muted">全 20 件</span></div>
          <div class="panel-body small text-muted">進行中、承認済み、差し戻し済みの文書はここで確認できます。</div>
        </div>
