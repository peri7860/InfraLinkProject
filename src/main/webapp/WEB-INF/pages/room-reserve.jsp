      ...
      <section class="col-lg-9">
            ...
            <table class="table list-table mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td>3階 大会議室</td>
                  <td><a href="${pageContext.request.contextPath}/pages/room-view.do" class="title-link">週次チーム定例会議</a></td>
                  <td class="text-center">田中 誠</td>
                </tr>
                <tr>
                  <td class="text-center">14:00〜15:30</td>
                  <td>役員会議室</td>
                  <td><a href="${pageContext.request.contextPath}/pages/room-view.do" class="title-link">第2四半期 実績報告</a></td>
                  <td class="text-center">山田 太郎</td>
                </tr>
                <tr>
                  <td class="text-center">16:00〜17:00</td>
                  <td>2階 セミナー室</td>
                  <td><a href="${pageContext.request.contextPath}/pages/room-view.do" class="title-link">新規プロジェクト キックオフミーティング</a></td>
        ...
        <div class="panel mt-4">
          <div class="panel-header">
            ...
            <span class="text-muted" style="font-size:.8rem;">変更・キャンセルが可能です</span>
          </div>
          <div class="table-scroll">
            <table class="table list-table mb-0">
              <thead><tr><th>日時</th><th>会議室</th><th>会議名</th><th class="text-center">操作</th></tr></thead>
              <tbody><tr><td>08/18 14:00〜15:00</td><td>3階 大会議室</td><td>新規プロジェクト企画レビュー</td><td class="text-center">
              <button class="btn btn-outline-teal btn-sm"onclick="location.href='${pageContext.request.contextPath}/pages/room-write.do'">変更</button> 
              <button class="btn btn-outline-danger btn-sm">キャンセル</button></td></tr></tbody>
            </table>
          </div>
        </div>
      </section>
