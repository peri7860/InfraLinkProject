      ...
      <section class="col-lg-9">
        ...
        <div class="panel mt-3">
          ...
          <div class="p-3">
			...
			<div class="d-flex gap-3 mb-3 pb-3 border-bottom"><div class="employee-card avatar" style="width:38px;height:38px;font-size:.9rem;flex-shrink:0;">佐</div><div class="flex-grow-1"><div class="fw-bold small">佐藤 花子 <span class="badge-normal ms-1">本人</span><span class="text-muted fw-normal ms-2" style="font-size:.75rem;">2026.08.13 12:05</span></div><div class="small mt-1">ご意見ありがとうございます。運営チームに共有します。</div><div class="mt-2"><button class="btn btn-link btn-sm p-0 me-2">編集</button><button class="btn btn-link text-danger btn-sm p-0">削除</button></div></div></div><button class="btn btn-outline-secondary btn-sm w-100">コメントをもっと見る</button>
            <div class="d-flex gap-3 mb-3 pb-3 border-bottom">
