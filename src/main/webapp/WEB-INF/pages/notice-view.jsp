  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}notice.co">お知らせ</a></li>
      ...
      <section class="col-lg-9">
        <div class="panel">
          ...
          <div class="view-footer">
            <a href="${pageContext.request.contextPath}/pages/notice.do" class="btn btn-outline-secondary btn-sm"><i class="bi bi-list"></i> 一覧に戻る</a>
            <div class="d-flex gap-2">
              <a href="${pageContext.request.contextPath}/pages/notice-write.do" class="btn btn-outline-teal btn-sm"><i class="bi bi-pencil"></i> 編集</a>
        ...
        <div class="panel mt-3">
          <a href="${pageContext.request.contextPath}/pages/notice-view.do" class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom text-decoration-none" style="color:var(--ink);">
          ...
          <a href="${pageContext.request.contextPath}/pages/notice-view.do" class="d-flex justify-content-between align-items-center px-3 py-2 text-decoration-none" style="color:var(--ink);">
