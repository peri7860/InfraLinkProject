  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/pages/employee.do">社員検索</a></li>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-4">
            <div class="panel text-center p-4">
              ...
              <hr>
              <a href="${pageContext.request.contextPath}/pages/messenger.do" class="btn btn-teal btn-sm w-100 mb-2"><i class="bi bi-chat-dots"></i> メッセージを送る</a>
