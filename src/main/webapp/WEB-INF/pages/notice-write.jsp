  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/pages/notice.do">お知らせ</a></li>
        ...
        <div class="panel">
          ...
          <form class="form-panel" id="noticeWriteForm">
            ...
            <div class="form-actions">
              <a href="${pageContext.request.contextPath}notice.do" class="btn btn-outline-secondary px-4">キャンセル</a>
