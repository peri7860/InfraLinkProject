  ...
  <div class="container">
    ...
    <div class="row row-cols-3 row-cols-md-4 row-cols-lg-6 g-3">
      ...
      <div class="col">
        ...
        <div class="col">
        <a href="${pageContext.request.contextPath}/pages/admin-dashboard.do" class="quick-btn">
      ...
      <aside class="col-lg-4">
        ...
        <div class="panel widget">
          <div class="panel-header">
            ...
            <a href="${pageContext.request.contextPath}/pages/approval.do" class="panel-link">すべて見る <i class="bi bi-chevron-right"></i></a>
          </div>
